...
public class ExcelUtils {
     ...
     * @throws Exception
     */
    public static void getUserUploadModel(OutputStream outputStream) throws Exception{
     ...
     * @throws Exception
     */
    public static List<Map<String, Object>> readerExcel(MultipartFile multipartFile) throws Exception{
     ...
     * @throws Exception
     */
    public static Map<Integer, Map<String, Object>> readerExcelAndRow(MultipartFile multipartFile) throws Exception{
        ExcelUtils excelUtils = new ExcelUtils();
        if(null == multipartFile) return null;
     ...
     * @throws Exception
     */
    public static  <T> List<T> readerExcel(MultipartFile multipartFile, Class<T> tagClass) throws Exception{
        List<Map<String, Object>> resultList = ExcelUtils.readerExcel(multipartFile);
