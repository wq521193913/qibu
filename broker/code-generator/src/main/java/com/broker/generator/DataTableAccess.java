...
public class DataTableAccess {
    ...
    private void connect(){
        try {
//            String url = "jdbc:mysql://192.168.22.90:3306/aaplateform?user=root&password=&useUnicode=true&characterEncoding=utf-8";
            String url = "jdbc:mysql://localhost:3306/" + dataBase + "?user=root&password=root&useUnicode=true&characterEncoding=utf-8";
