...
import com.qibu.wxapi.util.WxTransactionIdRequied;

import javax.validation.constraints.NotNull;

/**
 * @author: Administrator
 * @description: 微信退款需要传的参数
...
public class WxRefundParam {
     ...
     */
    @NotNull(message = "小程序ID(appid)不可为空")
    private String appid;
    /**
     * 商户号	mch_id	是	String(32)	1900000109	微信支付分配的商户号
     */
    @NotNull(message = "商户号(mch_id)不可为空")
     ...
     */
    @NotNull(message = "微信订单号(transaction_id)不可为空",groups = WxTransactionIdRequied.class)
     ...
     */
    @NotNull(message = "商户退款单号(out_refund_no)不可为空")
    private String out_refund_no;
    /**
     * 订单金额	total_fee	是	Int	100	订单总金额，单位为分，只能为整数，详见支付金额
     */
    @NotNull(message = "订单金额(total_fee)不可为空")
    private int total_fee;
    /**
     * 退款金额	refund_fee	是	Int	100	退款总金额，订单总金额，单位为分，只能为整数，详见支付金额
     */
    @NotNull(message = "退款金额(refund_fee)不可为空")
