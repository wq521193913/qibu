...
!function (a, b) {
    ...
    },a.loadingMask = function (b) {
        var d = c.createElement("div");
        d.style.textAlign = "center";

        var ld = c.createElement("div");
        // ld.style.backgroundColor = "white";
        ld.style.width = "100px";
        ld.style.margin = "0 auto";
        ld.style.lineHeight = "40";

        var l = c.createElement("span");
        l.classList.add("mui-spinner");
        l.classList.add("mui-spinner-white");
